...
| **!permban**  | _<имя_игрока>_  | Забанить игрока навсегда        |
| **!clearban**  | _<имя игрока>_  | Убрать бан для ранее забаненного игрока         |
| **!clearbans**  |   | Снять все баны         |
| **!mutelist, !mutes**  |   | Список замьюченных игроков         |
| **!banlist, !bans**  |   | Список забаненных игроков. В скобках указан тот, кто забанил        |
